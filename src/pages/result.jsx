...
function Result() {
  ...
  const results = {
    film: {
      ...
      productImage: "/src/assets/에브리타임필름.png",
      productColor: "#FFEFF1",
    ...
    comfy: {
      ...
      productImage: "/src/assets/에브리타임필름컴피.png",
      productColor: "#FAEEFF",
    ...
    mango: {
      ...
      productImage: "/src/assets/에브리타임플레이버망고.png",
      productColor: "#FDF1D5",
    ...
    pear: {
      ...
      productImage: "/src/assets/에브리타임플레이버배.png",
      productColor: "#F2FDD5",
    ...
    sevenberry: {
      ...
      productImage: "/src/assets/에브리타임플레이버세븐베리.png",
      productColor: "#FDEFFF",
